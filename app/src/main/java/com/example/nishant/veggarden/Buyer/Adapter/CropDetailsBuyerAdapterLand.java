...
import com.example.nishant.veggarden.Buyer.RequestForCropActivity;
import com.example.nishant.veggarden.Data.Crops;
import com.example.nishant.veggarden.R;

import java.util.List;

public class CropDetailsBuyerAdapterLand extends RecyclerView.Adapter<CropDetailsBuyerAdapterLand.CropDetailsLandViewHolder>{

    Context mCtx;
    List<Crops> cropsList;

    public CropDetailsBuyerAdapterLand(Context mCtx, List<Crops> cropsList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(CropDetailsLandViewHolder holder, int position) {
        ...
        holder.mCropDetailsCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent editCrop = new Intent(mCtx, RequestForCropActivity.class);
